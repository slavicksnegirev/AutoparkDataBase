...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollArea = QScrollArea(self.page_8)
        ...
        self.verticalLayout_6.addWidget(self.report1)
        ...
        self.gridLayout_9.addWidget(self.dateEdit_2, 2, 1, 1, 1)

        self.end_1 = QLabel(self.scrollAreaWidgetContents)
        self.end_1.setObjectName(u"end_1")
        self.end_1.setMinimumSize(QSize(0, 21))
        font = QFont()
        font.setFamilies([u"Noto Sans Kannada"])
        self.end_1.setFont(font)
        self.end_1.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)

        self.gridLayout_9.addWidget(self.end_1, 2, 0, 1, 1)

        self.dateEdit_1 = QDateEdit(self.scrollAreaWidgetContents)
        self.dateEdit_1.setObjectName(u"dateEdit_1")

        self.gridLayout_9.addWidget(self.dateEdit_1, 1, 1, 1, 1)

        self.comboBox_1 = QComboBox(self.scrollAreaWidgetContents)
        self.comboBox_1.setObjectName(u"comboBox_1")

        self.gridLayout_9.addWidget(self.comboBox_1, 0, 1, 1, 1)

        self.car = QLabel(self.scrollAreaWidgetContents)
        self.car.setObjectName(u"car")
        self.car.setMinimumSize(QSize(0, 21))
        self.car.setFont(font)
        self.car.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)

        self.gridLayout_9.addWidget(self.car, 0, 0, 1, 1)

        self.start_1 = QLabel(self.scrollAreaWidgetContents)
        self.start_1.setObjectName(u"start_1")
        self.start_1.setMinimumSize(QSize(0, 21))
        self.start_1.setFont(font)
        self.start_1.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)

        self.gridLayout_9.addWidget(self.start_1, 1, 0, 1, 1)

        self.report_1 = QPushButton(self.scrollAreaWidgetContents)
        self.report_1.setObjectName(u"report_1")
        self.report_1.setMinimumSize(QSize(180, 0))
        ...
        self.gridLayout_9.addWidget(self.report_1, 3, 0, 1, 1)
        ...
        self.report2 = QLabel(self.scrollAreaWidgetContents)
        self.report2.setObjectName(u"report2")

        self.verticalLayout_6.addWidget(self.report2)

        self.gridLayout_10 = QGridLayout()
        self.gridLayout_10.setObjectName(u"gridLayout_10")
        self.report_2 = QPushButton(self.scrollAreaWidgetContents)
        self.report_2.setObjectName(u"report_2")
        self.report_2.setMinimumSize(QSize(180, 0))
        self.report_2.setMaximumSize(QSize(50, 16777215))
        self.report_2.setIcon(icon4)
        self.report_2.setIconSize(QSize(32, 32))

        self.gridLayout_10.addWidget(self.report_2, 3, 0, 1, 1)

        self.start_2 = QLabel(self.scrollAreaWidgetContents)
        self.start_2.setObjectName(u"start_2")
        self.start_2.setMinimumSize(QSize(0, 21))
        self.start_2.setFont(font)
        self.start_2.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)

        self.gridLayout_10.addWidget(self.start_2, 1, 0, 1, 1)

        self.mechanic = QLabel(self.scrollAreaWidgetContents)
        self.mechanic.setObjectName(u"mechanic")
        self.mechanic.setMinimumSize(QSize(0, 21))
        self.mechanic.setFont(font)
        self.mechanic.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)

        self.gridLayout_10.addWidget(self.mechanic, 0, 0, 1, 1)
        ...
        self.end_2.setMinimumSize(QSize(0, 21))
        self.end_2.setFont(font)
        self.end_2.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)
        ...
        self.report3 = QLabel(self.scrollAreaWidgetContents)
        self.report3.setObjectName(u"report3")

        self.verticalLayout_6.addWidget(self.report3)

        self.gridLayout_11 = QGridLayout()
        self.gridLayout_11.setObjectName(u"gridLayout_11")
        self.driver = QLabel(self.scrollAreaWidgetContents)
        self.driver.setObjectName(u"driver")
        self.driver.setMinimumSize(QSize(0, 21))
        ...
        self.start_3.setMinimumSize(QSize(0, 21))
        self.start_3.setFont(font)
        self.start_3.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)

        self.gridLayout_11.addWidget(self.start_3, 1, 0, 1, 1)

        self.end_3 = QLabel(self.scrollAreaWidgetContents)
        self.end_3.setObjectName(u"end_3")
        self.end_3.setMinimumSize(QSize(0, 21))
        self.end_3.setFont(font)
        self.end_3.setAlignment(Qt.AlignBottom|Qt.AlignLeading|Qt.AlignLeft)

        self.gridLayout_11.addWidget(self.end_3, 2, 0, 1, 1)

        self.horizontalSpacer_13 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_11.addItem(self.horizontalSpacer_13, 0, 2, 1, 1)

        self.report_3 = QPushButton(self.scrollAreaWidgetContents)
        self.report_3.setObjectName(u"report_3")
        self.report_3.setMinimumSize(QSize(180, 0))
        self.report_3.setMaximumSize(QSize(50, 16777215))
        self.report_3.setIcon(icon4)
        self.report_3.setIconSize(QSize(32, 32))

        self.gridLayout_11.addWidget(self.report_3, 3, 0, 1, 1)
        ...
        self.pushButton_edit_9.setIcon(icon2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_9.setText(QCoreApplication.translate("MainWindow", u"\u0420\u0430\u0431\u043e\u0442\u043d\u0438\u043a\u0438", None))
        ...
        self.report1.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; text-decoration: underline;\">\u041e\u0442\u0447\u0435\u0442 \u21161</span><span style=\" font-size:14pt;\"> - \u0432\u044b\u0432\u043e\u0434 \u0432\u0441\u0435\u0445 \u043f\u043e\u0435\u0437\u0434\u043e\u043a \u043a\u043e\u043d\u0442\u0440\u0435\u043a\u0442\u043d\u043e\u0433\u043e \u0430\u0432\u0442\u043e\u043c\u043e\u0431\u0438\u043b\u044f \u0437\u0430 \u0443\u043a\u0430\u0437\u0430\u043d\u043d\u044b\u0439 \u043f\u0435\u0440\u0438\u043e\u0434</span></p></body></html>", None))
        self.dateEdit_2.setDisplayFormat(QCoreApplication.translate("MainWindow", u"yyyy-MM-dd", None))
        self.end_1.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:14pt;\">\u041a\u043e\u043d\u0435\u0446 \u043e\u0442\u0447\u0435\u0442\u043d\u043e\u0433\u043e \u043f\u0435\u0440\u0438\u043e\u0434\u0430:</span></p></body></html>", None))
        self.dateEdit_1.setDisplayFormat(QCoreApplication.translate("MainWindow", u"yyyy-MM-dd", None))
        self.car.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:14pt;\">\u041c\u0430\u0448\u0438\u043d\u0430:</span></p></body></html>", None))
        self.start_1.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:14pt;\">\u041d\u0430\u0447\u0430\u043b\u043e \u043e\u0442\u0447\u0435\u0442\u043d\u043e\u0433\u043e \u043f\u0435\u0440\u0438\u043e\u0434\u0430:</span></p></body></html>", None))
        self.report_1.setText(QCoreApplication.translate("MainWindow", u"\u0421\u0444\u043e\u0440\u043c\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u043e\u0442\u0447\u0435\u0442", None))
        self.report2.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; text-decoration: underline;\">\u041e\u0442\u0447\u0435\u0442 \u21162</span><span style=\" font-size:14pt;\"> - \u0432\u044b\u0432\u043e\u0434 \u0432\u0441\u0435\u0445 \u0440\u0435\u043c\u043e\u043d\u0442\u043e\u0432 \u043a\u043e\u043d\u0442\u0440\u0435\u043a\u0442\u043d\u043e\u0433\u043e \u043c\u0435\u0445\u0430\u043d\u0438\u043a\u0430 \u0437\u0430 \u0443\u043a\u0430\u0437\u0430\u043d\u043d\u044b\u0439 \u043f\u0435\u0440\u0438\u043e\u0434</span></p></body></html>", None))
        ...
        ___qtablewidgetitem50.setText(QCoreApplication.translate("MainWindow", u"\u0424\u0418\u041e \u0440\u0430\u0431\u043e\u0442\u043d\u0438\u043a\u0430", None));
        ___qtablewidgetitem51 = self.tableWidget_9.horizontalHeaderItem(2)
        ___qtablewidgetitem51.setText(QCoreApplication.translate("MainWindow", u"\u041f\u0430\u0440\u043e\u043b\u044c", None));
    # retranslateUi
